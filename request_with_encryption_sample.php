...
$success = openssl_public_encrypt($aes_key, $enc, loadKey("v1"));
echo "encrypt result = ".$success."\r\n";
$encrypted_aes_key = urlencode(base64_encode($enc));
...
$encryption_header = $headers["encrypt"];
echo "encrypt header =".$encryption_header."\r\n";
$encrypt_aes_key = after("symmetricKey=", $encryption_header);
echo "encrypt aws key =".$encrypt_aes_key."\r\n";

openssl_private_decrypt(base64_decode(urldecode($encrypt_aes_key)), $decrypted_aes_key, $pkeyid);
